var app = (function () {
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(h1, file, 10, 4, 216);
				attr_dev(button, "class", "bg-blue-600");
				add_location(button, file, 11, 4, 265);
				add_location(main, file, 9, 2, 205);
			},
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = listen_dev(button, "click", /*openFullscreen*/ ctx[1], false);
					mounted = true;
				}
			},
	...
	function instance($$self, $$props, $$invalidate) {
		...
		$$self.$capture_state = () => ({ browser, name, openFullscreen });
